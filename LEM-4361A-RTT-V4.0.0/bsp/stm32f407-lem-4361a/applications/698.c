...
//记录的 N 列属性描述符 RCSD，
	...
	_698_oad_omd(0x3408,0x0200,hplc_data);	// 充电计划上报事件
...
//记录的 N 列属性描述符 RCSD，
	...
	_698_oad_omd(0x3404,0x0200,hplc_data);	// 充电计划上报事件
